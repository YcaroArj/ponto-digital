                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="selectStatus" name="cargo">
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="selectStatus" name="TipoContrato">
                                                <option value="" disabled selected hidden></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="selectStatus" name="TipoUsuario">
                                                <option value="" disabled selected hidden></option>
