...
@section('content')
    <div class="div-content">
        <div class="div-container-funcionarios"> <!-- Button trigger modal --> <button type="button"
                class="btn-cad
    btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Cadastrar
                Funcionário </button> <!-- Modal
        -->
            ...
            @if (session('error'))
                <div class="alert alert-danger" role="alert" id="liveAlertPlaceholder"
                    style="display: flex; margin-top: 10px; justify-content: space-between;">
                    {{ session('error') }}
                    <button class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            @endif
            @if (session('success'))
                <div class="alert alert-success" role="alert" id="liveAlertPlaceholder"
                    style="display: flex; margin-top: 10px; justify-content: space-between;">
                    {{ session('success') }}
                    <button class="btn-close" data-bs-dismiss="alert"></button>
                </div>
                    ...
                    <tbody>
                        @foreach ($queryUsers->sortBy('nome') as $item)
                            <tr>
                                ...
                                <td>
                                    <a data-bs-toggle="modal" data-bs-target="#ModalEdit{{ $item->id }}"
                                        class="fav-icon-edit"><ion-icon name="create"></ion-icon></a>
                                    ...
                                    <div class="modal fade" id="ModalEdit{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Usuário
                                                    </h1>
                                                </div>
                                                <form action="{{ route('update-user', ['id' => $item->id]) }} "
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="col-sm">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="nome"
                                                                        class="form-control" value="{{ $item->nome }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm">
                                                                <div class="mb-3">
                                                            ...
                                                            <div class="col-sm">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control" id="selectStatus"
                                                                        ...
                                                                        <option value="Secretário de Educação">Secretário
                                                                            de Educação</option>
                                                                        <option value="Sub-Secretário de Educação">
                                                                            Sub-Secretário de Educação</option>
                                                                        <option value="Assessor l">Assessor l</option>
                                                                        <option value="Assessor ll">Assessor ll</option>
                                                                        <option value="Assessor lll">Assessor lll</option>
                                                                        <option value="Estágiario">Estágiario</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm">
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
                                                                        class="form-label">Tipo de Usuário</label>
                                                                    <select class="form-control" id="selectStatus"
                                                                        name="TipoUsuario">
                                                                        <option value="" disabled selected hidden>
                                                                        </option>
                                                        ...
                                                        <div class="row">
                                                            <!-- <input type="file" id="image" name="image" class="from-control-file"> -->
                                                            <div class="mb-3">
                                                                <label for="formFile" class="form-label">Escolher foto de
                                                                    perfil</label>
                                                            ...
                                                            <div class="row"
                                                                ...
                                                                <button type="button" class="btn-modal btn-secondary"
                                                                    data-bs-dismiss="modal">Fechar</button>
                                                                <button type="submit"
                                                                    class="btn-modal btn-primary">Cadastrar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div>
            ...
            <a data-bs-toggle="modal" data-bs-target="#ModalDelet{{ $item->id }}" class="fav-icon-delet"><ion-icon
                    name="trash"></ion-icon></a>
            <!-- Modal -->
            <div class="modal fade" id="ModalDelet{{ $item->id }}" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="footer-delet modal-footer">
                            <form action="{{ route('user-destroy', ['id' => $item->id]) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn-delet btn-secondary"
