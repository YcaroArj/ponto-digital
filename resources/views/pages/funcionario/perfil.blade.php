            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="coluna-dados col">
                        <input class="input-perfil" type="text" name="nome" id="nome" placeholder="Nome"
                            value="{{ Auth::user()->nome }}" disabled="">
                        <input class="input-perfil" type="text" name="email" id="email" placeholder="E-mail"
